...
var file_lib_1 = require("../lib/file.lib");
exports.FileAPI = react_1.createApi({
    reducerPath: 'fileAPI',
    baseQuery: react_1.fetchBaseQuery({
        baseUrl: interceptors_1.options.baseURL + 'fileservice/api/FilesS3'
    }),
    endpoints: function (build) { return ({
        getFile: build.mutation({
            query: function (_a) {
                var fileId = _a.fileId, _b = _a.toFile, toFile = _b === void 0 ? false : _b;
                return ({
                    url: "/GetFile/" + fileId,
                    method: 'GET',
                    responseHandler: function (response) { return __awaiter(void 0, void 0, void 0, function () {
                        var data, blob, file, format;
