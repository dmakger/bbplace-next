...
exports.ToChatSmallToSupplierButton = function (_a) {
    ...
    return (React.createElement(Button_1.Button, { variant: Button_1.ButtonVariant.BACKGROUND_GRAY, href: pages_url_config_1.DASHBOARD_PAGES.CHATS(supplierId).path, className: classes_lib_1.cls(className, isWide ? _ToChatSmallToSupplierButton_module_scss_1["default"].buttonWide : '') },
