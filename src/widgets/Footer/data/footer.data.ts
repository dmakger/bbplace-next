...
import { BBP_PRESENTATION_DOCUMENT, COOKIE_POLICY_DOCUMENT, DATA_PROCESSING_DOCUMENT, DATA_PROCESSING_POLICY_DOCUMENT, OFFERT_DOCUMENT } from "@/shared/data/documents.data";
...
export const COOKIE_POLICY_DOCUMENT_LINK_ITEM: IMenuItem = {
    link: MAIN_PAGES.CURRENT_DOCUMENT(COOKIE_POLICY_DOCUMENT).path,
    title: 'Политика в отношении обработки cookie-файлов',
}
...
export const DOCUMENTS_LINK_ITEMS_ARRAY: IMenuItem[] = [
    ...
    COOKIE_POLICY_DOCUMENT_LINK_ITEM
]
