...
const ItemsIcon = ({ width = 28, height = 27 }: IIcons) => (
	<svg width={width} height={height} viewBox="0 0 28 27" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g clipPath="url(#clip0_939_5871)">
			...
			<path d="M6.125 9V20.25C6.125 20.8467 6.36205 21.419 6.78401 21.841C7.20597 22.2629 7.77826 22.5 8.375 22.5H19.625C20.2217 22.5 20.794 22.2629 21.216 21.841C21.6379 21.419 21.875 20.8467 21.875 20.25V9" stroke="#28252E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
			<path d="M11.75 13.5H16.25" stroke="#28252E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
		</g>
		<defs>
