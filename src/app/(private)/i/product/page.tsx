'use client'
import { SWITCH_SELECTOR_CREATED_PRODUCTS_OPTION, SWITCH_SELECTOR_WO_PRICE_PRODUCTS_OPTION } from "@/shared/ui/SwitchSelector/data/switchSelector.data"
...
export default function LKProductPage() {
    ...
    //API
    const { data: activeProductsAPI } = ProductAPI.useGetProductsByUserQuery({ userId, limit: 100000000, page: 0 }, { refetchOnMountOrArgChange: true })
