...
import { LK_PRODUCT_PAGE_EDIT, ProductsTypeLK, SWITCH_SELECTOR_PRODUCT_EDIT_PAGE_SINGLE } from "@/shared/ui/SwitchSelector/data/switchSelector.data";
            ...
            <SuspenseL>
                <SuspenseL.Any data={[
                    ...
                    <WrapperLKPT options={LK_PRODUCT_PAGE_EDIT}
                        pageTitle={""}
                        buttonBackProps={{href: DASHBOARD_PAGES.PRODUCTS(typeProduct === ProductsTypeLK.Draft).path}}
