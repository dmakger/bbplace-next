...
export const FAVORITES_WOT_ITEM_MENU_DATA: IMenuItem = {
    link: DASHBOARD_PAGES.FAVORITE,
    image: FavoriteSVG,
}

export const CHATS_WOT_ITEM_MENU_DATA: IMenuItem = {
...
export const FAVORITES_WT_ITEM_MENU_DATA: IMenuItem = {
    title: 'Избранное',
    ...FAVORITES_WOT_ITEM_MENU_DATA
}

export const CHATS_WT_ITEM_MENU_DATA: IMenuItem = {
    title: 'Чат',
    ...CHATS_WOT_ITEM_MENU_DATA
}
